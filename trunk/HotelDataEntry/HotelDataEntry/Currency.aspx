    ...
    <asp:UpdatePanel ID="updatepanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <cc1:JQGrid ID="JqgridCurrency" AutoWidth="True" runat="server" Height="80%" OnRowAdding="JqgridCurrency_RowAdding"
                ...
                <Columns>
                    <cc1:JQGridColumn DataField="CurrencyId" Searchable="False" PrimaryKey="True" Width="55" Visible="False">
                    </cc1:JQGridColumn>
                ...
                <AddDialogSettings Width="300" Modal="True" TopOffset="250" LeftOffset="500" Height="300"
                    CloseAfterAdding="True" Caption="Add Currency" ClearAfterAdding="True"></AddDialogSettings>
                <EditDialogSettings Width="300" Modal="True" TopOffset="250" LeftOffset="500" Height="300"
                    CloseAfterEditing="True" Caption="Edit Currency"></EditDialogSettings>
            </cc1:JQGrid>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
