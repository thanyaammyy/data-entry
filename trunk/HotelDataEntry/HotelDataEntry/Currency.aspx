...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="headerMenuLabel"> Currency Management</div>

    <asp:UpdatePanel ID="updatepanel1" UpdateMode="Conditional" runat="server">
        <ContentTemplate>
            <cc1:JQGrid ID="JqgridCurrency" AutoWidth="True" runat="server" Height="100%" 
                onrowadding="JqgridCurrency_RowAdding" 
                onrowdeleting="JqgridCurrency_RowDeleting" 
                onrowediting="JqgridCurrency_RowEditing">
                <Columns>
