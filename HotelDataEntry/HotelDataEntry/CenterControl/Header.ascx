    ...
    <div style="padding-left: 50px; padding-bottom: 20px; padding-right: 20px; padding-top: 20px; margin: auto;">
        <p align="center" style="font-size: 12px; font-family: Helvetica;">
            ...
            <div id="divAdmin" style="padding-left: 10px; float: left; display: none" runat="server">
                ...
                <a href="../Property.aspx" id="propMa">Property Maintenance</a> <span style="color: black; padding: 2px">l</span> 
                <a href="../User.aspx" id="userMa">User Maintenance</a> <span  style="color: black;padding: 2px">l</span> 
                <a href="../Currency.aspx" id="currencyMa">Currency Maintenance</a>
            </div>
